...
async function displayHeroPage(e) {
  let heroPagePath = `${window.location.pathname} + /../Superhero.html#id=${e.target.parentElement.id}`;
...
async function updateFavouriteHeroes() {
  ...
  for (let i = 0; i < favourites.length; i++) {
    ...
    let url = `https://superheroapi.com/api.php/1519513091818489/${favourites[i]}`;
